...
Below is a regression model using the main effects `year`, `condition`, `starters`, and  the interaction between year and condition to understand variation in `speed`. Use the output for exercises 1 - 4. 
