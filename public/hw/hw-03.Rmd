...
Below is a regression model using the main effects `year`, `condition`, `startersCent`, and  the interaction between year and condition to understand variation in `speed`. Use the output for exercises 1 - 4. 
...
3. Use the confidence intervals in the regression output to answer each analysis question. For each question, state the confidence interval you used and state your conclusion in the context of the data.
   ...
   - What is the estimated winning speed for races in 1896 that included 14 horses on fast track conditions?
