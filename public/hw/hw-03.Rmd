...
Below is a regression model using the main effects `year`, `condition`, `starters`, and  the interaction between year and condition to understand variation in `speed`. Use this table to answer exercises 1 - 4. 
...
3. Use the confidence intervals in the regression output to answer each analysis question. For each question, state the confidence interval you used and state your conclusion in the context of the data.
   ...
   - What is the estimated winning speed for races in 1896 that included 14 horses?
...
**Use the following scenario and data for questions 5 - 8.**
...
1. Fit the model and display the output using 3 digits. Then, interpret the coefficient of `gestation` in the context of the data.
