...
`r emo::ji("white_check_mark")` Create a GitHub repo for your TidyTuesday submission. Your repo should include 
...
`r emo::ji("white_check_mark")` The visualization should include features or customization that are beyond what we've done in class . 

`r emo::ji("white_check_mark")` Include the link to your GitHub repo in the slide summarizing your experience.
