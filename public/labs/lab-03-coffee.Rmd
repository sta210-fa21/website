...
5. Next, let's examine if there are any points with standardized residuals that have large magnitude.  Are there any such points in the data? Briefly explain, including any output, graphs, etc. you used to determine the response. 
