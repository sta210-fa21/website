...
- We'll use the "August 25 Lecture" thread pinned to the top of Ed Discussion: https://edstem.org/us/courses/8350/discussion/
...
Let's take a tour of R and RStudio. Go to [vm-manage.oit.duke.edu](https://vm-manage.oit.duke.edu) and open the **STA210** Docker containers. 
