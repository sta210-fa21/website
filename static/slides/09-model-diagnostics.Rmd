...
## [Click here for PDF of slides](09-model-diagnostics.pdf)
...
- Response variable:
  + .vocab[`SAT`]: average total SAT score

- Predictor variable: 
  + .vocab[`Takers`]: percentage of high school seniors who took exam
...
High leverage if $h_i > \frac{2 * (1 + 1)}{50} = 0.08$
