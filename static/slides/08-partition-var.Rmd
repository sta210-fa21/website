...
## [Click here for PDF of slides](08-partition-var.pdf)
...
include_graphics("img/07/model-anova.png")
```
...
cats_anova %>%
  kable(format = "html", digits = 3) %>%
  column_spec(3, background = "#dce5b2")
```
...
cats_anova %>%
  kable(format = "html", digits = 3) %>%
  column_spec(2, background = "#dce5b2")
```
