...
.vocab[We are 95% confident that for each additional month in a child's age, the respiratory rate multiplies by a factor of `r round(exp(-0.02),3)` to `r round(exp(-0.018),3)` (exp{-0.02} to exp{-0.018}).]
