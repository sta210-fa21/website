...
You can find the definitions for all variables in the data set [here](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-07-07/readme.md). [Click here](http://www.scaa.org/?page=resources&d=cupping-protocols&mod=article_inline
) for more details about how these measures are obtained. 
...
6. Lastly, let's analyze Cook's D to determine if there are influential points in the data. 
    ...
    - If there are influential points, would you recommend removing these points from the data and refitting the model? Briefly explain why or why not. Additionally, briefly explain potential impacts your choice has on inferential conclusions and/or predictions.
